...
class Methyl:
    ...
    def get_tsv_line(self):
        ...
        ss += "\t" + str(self._modified_reads_1) + "\t" + str(self._total_reads_1) + "\t" + str(self._modified_reads_1/self._total_reads_1)  
        ss += "\t" + str(self._modified_reads_2) + "\t" + str(self._total_reads_2) + "\t" + str(self._modified_reads_2/self._total_reads_2) + "\n" 
        return ss 
